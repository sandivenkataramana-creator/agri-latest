...
const DashboardStaff = () => {
  ...
  const getStatusIcon = (status) => {
    switch (status) {
      case 'present':
        return <FiCheckCircle className="status-icon status-present" />;
      case 'absent':
        return <FiXCircle className="status-icon status-absent" />;
      case 'half_day':
        return <FiClock className="status-icon status-half" />;
      case 'leave':
        return <FiCalendar className="status-icon status-leave" />;
      default:
